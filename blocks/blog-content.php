    ...
    <div class="container">
      <div class="blogs__list" id="blogList">
        ...
        <wb-foreach wb="{
          ...
          <a class="blog-panel blog-panel--33" href="/blog/{{wbFurlGenerate({{header}})}}"
             style="background-image: url('{{cover.0.img}}')">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="blog-inner__aside">
            <p class="blog-inner__message">Чтобы попасть на процедуру или консультацию к нашим специалистам, позвоните
              по телефону <a href="tel:+74950215945">+7 (495) 021-59-45</a></p>
          </div>
        </div>
        <div class="col-md-8">
          <div class="blog-inner__text">
            <div class="text mb-80">
              ...
              <p class="mb-10"> Дорогие пациенты! Как известно, самая лучшая защита от вирусной инфекции – это крепкий
                иммунитет.</p>
              <p class="mb-10">Мы уже рассказывали, что одним из значительных клинических эффектов BICOM-терапии
                является повышение иммунитета. Ежегодно мы рекомендуем и проводим для своих пациентов и сотрудников
                специальный курс биком-терапии в период сезонных простуд и гриппа для повышения сопротивляемости
                организма к инфекциям.</p>
              <p class="mb-10">Ввиду последних событий, мы дополнили стандартный курс специализированными программами,
                разработанными нашими коллегами из Германии, о чем рассказывали вам ранее в наших публикациях.</p>
            </div>
          </div>
        </div>
      </div>
