<view>
    <footer>
            ...
            <div class="container">
                <div class="container-fluid">
                    <div class="row footer__top">
                        ...
                        <div class="footer__item col-lg-7"><a class="footer__contact text-small text-grey" href="contacts.html"> г. Москва, Ростовская набережная д. 5, пом. 9</a></div>
                    </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="29px" viewBox="0 0 20 29" enable-background="new 0 0 20 29" xml:space="preserve" space="preserve">
            <path fill="#262626" d="M11.011,0.4c-0.534-0.533-1.397-0.533-1.929,0L0.4,9.082c-0.533,0.533-0.533,1.396,0,1.929 c0.532,0.533,1.396,0.533,1.929,0l7.717-7.717l7.717,7.717c0.533,0.533,1.397,0.533,1.93,0c0.533-0.532,0.533-1.396,0-1.929 L11.011,0.4z"></path>
            <rect x="8.682" y="1.364" fill="#262626" width="2.729" height="27.284"></rect>
        </svg>
    </div>
    </footer>
</view>
