<view head>
	...
	<script wb-app wb-if="in_array('{{_sess.user.role}}',['main','client','expert'])"
		src="/assets/js/cabinet.js?v=449F19A10CB940AFB6542FBE865208B2">
	</script>
	...
	<link href="/assets/css/new.css?v=EE25A9E0249B45848003370AF64B6208" rel="stylesheet">
	...
	<link wb-if="in_array('{{_sess.user.role}}', ['main','client','expert'])"
		href="/assets/css/cabinet.css?v=50C4808827F74CDBBA8C21F7982D0730" rel="stylesheet">
</view>
