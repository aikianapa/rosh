        ...
        <div class="input-group">
          <div class="cursor-pointer input-group-prepend" onclick="priceSelector(this)">
                        <span class="input-group-text">
                            <img data-src="/module/myicons/interface-essential-138.svg?size=20&amp;stroke=323232"
                                 width="20" height="20"
                                 src="/module/myicons/interface-essential-138.svg?size=24&amp;stroke=323232">
                        </span>
          </div>
        ...
        <div class="content-price">
          ...
          <div class="content-price__body">
            <wb-foreach wb="from=price&tpl=false">
              <div class="content-price__item row"
                   wb-if="'{{_var.pricelist.{{price_id}}.active}}' == 'on' && '{{_var.pricelist.{{price_id}}.header}}'>''">
                ...
                <div class="text-right col-3 col-md-2 content-price__summ text-nowrap" style="text-wrap:nowrap;">
                  {{fmtPrice({{_var.pricelist.{{price_id}}.price}})}}₽
                </div>
              </div>
            </wb-foreach>
            <p style="color:#b5b7b6;font-size: 14px;">Не является публичной офертой. Cтоимость указана приблизительно и
              может быть изменена в зависимости от фактически оказанных услуг</p>
          </div>
        ...
        <div class="col-md-9">
          <div class="content-price">
            ...
            <div class="content-price__body">
              ...
              <div class="content-price__item">
                <div class="content-price__name">Прием (осмотр, консультация) врача-дерматовенеролога главного врача
                  повторный ( по результатам анализов)
                </div>
                <div class="content-price__summ">2 500 ₽</div>
              </div>
              <div class="content-price__item">
                <div class="content-price__name">Прием (осмотр, диагностика, консультация) врача - косметолога-
                  первичный (включает составление плана лечения)
                </div>
                <div class="content-price__summ">2 500 ₽</div>
              </div>
              <div class="content-price__item">
              ...
              <div class="content-price__item">
                <div class="content-price__name">Прием (осмотр, консультация) врача-дерматовенеролога повторный
                  (включает составление плана лечения по результатам анализов) коррекция лечения
                </div>
