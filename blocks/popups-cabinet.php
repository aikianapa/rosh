			...
			<template id="popupPay">
				...
				<div class="popup__wrapper">
					<div class="popup__panel">
						...
						<div class="mt-20 text-grey form__description"><b>*</b>&nbsp;Нажимая на кнопку "Внести предоплату", Вы даете согласие на обработку своих персональных данных на основании <a target="_blank" href="/policy">Политики конфиденциальности</a>. Предоплата за услуги не возвращается. Не является публичной офертой.</div>
					</div>
