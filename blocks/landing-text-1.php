<view>
  <div class="landing landing-text" data-large-container="{{_parent.largeContainer}}">
    <div class="container">
      <div class="content">
      ...
      <div class="row --aicn mb-40" wb-if="'{{left}}'>'' OR '{{right}}'>''">
        <div class="col-lg-4">
          <div class="text-bold" wb-if="'{{left}}'>''">{{left}}</div>
        </div>
        <div class="col-lg-8">
          <div class="content-wrap">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="content-wrap">
            <div class="text mb-80">
              <p>Хотя, в большинстве случаев,виновником является не какой-то конкретный природный компонент продукта, а
                химические добавки: красители, консерванты, подсластители, усилители вкуса и т.д. Так как с каждым годом
                растет потребление подобных продуктов, врачи именно с этим, в первую очередь, и связывают высокий рост
                аллергических реакций в последнее время.</p>
            </div>
          </div>
        </div>
      </div>
