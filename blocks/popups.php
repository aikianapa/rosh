<view>
    ...
    <div class="popup --code">
        ...
        <div class="popup__panel">
            ...
            <form class="popup__form">
                ...
                <div class="form-title__description form-title__description--small">Мы отправили код подтверждения на номер <br>+7 939 319 33 38 <a class="link" href="#"> Изменить</a></div>
                <div class="code">
    ...
    <div class="popup --eq">
        ...
        <div class="popup__panel">
            ...
            <div class="text">
                <p class="mb-10">Медицинский центр "ROSH" представляет мультиплатформу Joule SCITON, которая на сегодня не знает аналогов во всем мире. Все Голливудские дивы уже по достоинству оценили и являются поклонниками данного аппарата.И есть от чего: единственная
                    преследуемая цель процедуры - это удовлетворенность пациентов конечными результатами. Лазер SCITON поистине универсален, чтобы предложить эффективную и безопасную коррекцию большинства патологий кожи (дерматологических и эстетических)
                    на всех типах кожи с минимальным восстановительным периодом и восхитительными результатами.
                </p>
            </div>
            <div class="gallery">
            ...
            <div class="text">
                ...
                <p>Кроме того, на данном аппарате проводится уникальная методика FOREVER YOUNG - мало того, что она устраняет абсолютно все недостатки, имеющиеся на лице и теле, это еще и омоложение на генном уровне!
                </p>
            </div>
        </div>
    </div>
