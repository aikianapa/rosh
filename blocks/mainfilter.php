                                ...
                                <div class="accardeon" data-category="{{id}}">
                                    ...
                                    <div class="accardeon__list">
                                        <div class="row">
                                            {{#each items}}
                                            <div class="col-lg-4">
                                                <label class="checkbox mainfilter__checkbox" data-id="{{../../id}}_{{id}}" data-color="{{../../data.color}}" data-cname="{{../../name}}"
                                                    data-service="{{id}}">
                                    ...
                                    <div class="accardeon">
                                        ...
                                        <div class="accardeon__list">
                                            <div class="row">
                                                {{#each items}}
                                                <div class="col-lg-4">
                                                    <label class="checkbox mainfilter__checkbox" data-id="{{category}}_{{id}}" data-color="{{../../data.color}}" data-cname="{{../../name}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <label class="checkbox mainfilter__checkbox" data-id="{{id}}" data-color="{{../../data.color}}" data-cname="{{../../name}}"
                                            ...
                                            <div class="checbox__name">{{header}}</div>
                                            <a class="checbox__link --openpopup" data-popup="--service-l"
                                                href="#" on-click="viewSymptom">Подробнее </a>
                                        </label>
                                    </div>
                                    {{/each}}
                                </div>
                            ...
                            <div class="mainfilter__tags">
                                ...
                                <div class="mainfilter-tag">
                                    <div class="mainfilter-tag__name">
                                        ...
                                        <a class="mainfilter-tag__link" href="#__srv" data-service="{{service}}" data-popup="--service-l"
                                            on-click="viewService">{{header}}</a>
                                    </div>
                                ...
                                <div class="mainfilter-tag">
                                    <div class="mainfilter-tag__name">
                                        ...
                                        <a class="mainfilter-tag__link" href="#__prb" data-problem="{{problem}}" data-popup="--service-l"
                                            on-click="viewProblem">{{header}}</a>
                                    </div>
                                    <div class="mainfilter-tag__group --{{color}}">{{liter}}</div>
                                </div>
                                {{/each}}
    ...
    <script wbapp>
        ...
        var mainFilter = new Ractive({
            ...
            on: {
                ...
                clearSymptoms() {
                    $(document).find('.mainfilter__tab[data-tab="sympthoms"] input[type="checkbox"]:checked').trigger(
                        'click')
                },
                clearProblems() {
                    $(document).find('.mainfilter__tab[data-tab="services"] input[type="checkbox"]:checked').trigger(
                        'click')
                    $(document).find('.mainfilter__tab[data-tab="problems"] input[type="checkbox"]:checked').trigger(
                        'click')
                },
                delete(ev) {
                    did = $(ev.node).data('id')
