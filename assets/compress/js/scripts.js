if (!document.loadedScripts) document.loadedScripts =[];document.loadedScripts.push('/assets/js/jquery.inputmask.min.js');document.loadedScripts.push('/assets/js/jquery.maskedinput.min.js');document.loadedScripts.push('/assets/js/jquery.autocomplete.min.js');document.loadedScripts.push('/assets/js/air-datepicker.js');document.loadedScripts.push('/assets/js/main.js');document.loadedScripts.push('/assets/js/new.js');document.loadedScripts.push('/assets/js/blogFilter.js');document.loadedScripts.push('/assets/js/auth.js');
;
