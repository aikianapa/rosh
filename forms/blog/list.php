...
<div class="m-3" id="yongerSpace">
    <nav class="nav navbar navbar-expand-md col">
        <h3 class="order-1 tx-bold tx-spacing--2">Блог</h3>
    ...
    <div class="mb-1 yonger-nested">
        <span class="bg-light">
            <div class="p-2 header">
                <span clsss="row">
                    <div class="col-3">
                        <input class="form-control" type="search" placeholder="Поиск..." data-ajax="{'target':'#{{_form}}List','filter':{ 'header': {'$like' : '$value'} } }">
                    </div>
                </span>
            </div>
        </span>
                    ...
                    <tr class="bg-transparent">
                        ...
                        <td class="w-25">
                            <wb-foreach wb="call=explode(',','{{tags}}')">
                                <small class="p-1 mr-1 d-flex-inline bg-light text-dark" wb-if="'{{_val}}'>''">{{_val}}</small>
                            </wb-foreach>
                        </td>
