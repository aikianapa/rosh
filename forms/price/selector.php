<div class="modal effect-scale" id="modalPriceSelect" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header row">
                <div class="col-11">
                    <input class="form-control" type="search" placeholder="Поиск..."
                    data-ajax="{'target':'#priceList','filter':{'$or':[{ 'header': {'$like' : '$value'} }, { 'price': {'$like' : '$value'} }  ]} }">
                </div>
