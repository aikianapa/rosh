...
<div class="m-3" id="yongerSpace">
    <div id="{{_form}}List">
        <nav class="nav navbar navbar-expand-md col">
            <h3 class="order-1 tx-bold tx-spacing--2">Оборудование</h3>
                ...
                {{#each result}}
                    <li class="list-group-item d-flex align-items-center" data-id="{{.id}}">
                        ...
                        <div class="text-right wd-20p">
                            ...
                            <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/equipment/edit/{{.id}}','html':'modals'}" class="d-inline">
...
<script language="javascript" src="/forms/{{_form}}/list.js"></script>