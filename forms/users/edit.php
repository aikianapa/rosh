            ...
            <div class="modal-body pd-20">
                ...
                <form id="{{_form}}EditForm" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <p class="p-1 d-block d-sm-none" />
                        <div class="input-group col-sm-6 col-12">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-phone"></i></span>
                            </div>
                            <input type="tel" wb-mask="+9 (999) 999-99-99" name="phone" class="form-control" wb-enabled="admin" placeholder="Телефон">
                        </div>
                    </div>

                    <div class="form-group row">
                        <div class="mb-2 input-group col-sm-4 col-12">
                            <div class="input-group-prepend">
