(() => {
    ...
    var form = "users"
    var size = 50
    var base = api + `/list/${form}?role=expert&@size=${size}&@sort=_sort&@return=first_name,last_name,middle_name,second_name,fullname,role,id,_id,_sort`
