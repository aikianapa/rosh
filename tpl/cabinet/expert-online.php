			...
			<div class="container">
				<div class="row">
					...
					<div class="text-center col-md-6">
						<h3 class="copy">Онлайн консультация</h3>
					</div>
					<div class="col-md-3">&nbsp;</div>
				</div>
				<div class="row" style="height: 80vh;">
					<iframe class="meeting-online d-none" style="width:100%;height: 100%" src="https://subdomain.whereby.com/room?minimal" allow="camera; microphone; fullscreen; speaker; display-capture; autoplay"></iframe>
				</div>
			</div>
		</main>
	</div>
