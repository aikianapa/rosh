                    ...
                    <div class="account">
                        ...
                        <div class="title-flex --flex --jcsb account-header align-items-center">
                                            ...
                                            <div class="select-form mb-0 w-100" data-hide="expert">
                                                <div class="select">
                                                    ...
                                                    <div class="select__list">
                                                        <div class="select__item active" data-child-id="{{user.id}}" on-click="select">Ваш
                                                        </div>
                            ...
                            <div class="--flex align-items-center" id="client-btns">
                                <template>
                                    {{#if !user.parent_id}}
                                        <button class="btn btn--black mr-20 --openpopup" data-popup="--children-create" onclick="popupCreateChildren()">
                                            Добавить ребёнка
                                        </button>
                                    {{/if}}
        ...
        <form on-submit="submit">
            ...
            {{#if !user.parent_id}}
                <div class="row profile-edit__wrap">
                    <div class="col-md-9">
                        <div class="input input--grey">
                            <input class="input__control" name="fullname" required value="{{ user.fullname }}" type="text" placeholder="ФИО">
                ...
                <div class="row profile-edit__wrap" data-child="false">
                    <div class="col-md-3">
                        <div class="input input--grey">
                            <input class="input__control datebirthdaypickr" name="birthdate" value="{{user.birthdate}}" type="text" required placeholder="Дата рождения" twoway="false">
                    ...
                    <div class="col-md-3">
                        <div class="input input--grey">
                            <input class="input__control" type="email" name="email" value="{{user.email}}" placeholder="E-mail" required>
                ...
                <div class="row profile-edit__wrap" data-child="false">
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="country" value="{{user.country}}" placeholder="Страна">
                                    <div class="input__placeholder input__placeholder--dark">Страна</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="city" value="{{user.city}}" placeholder="Город">
                                    <div class="input__placeholder input__placeholder--dark">Город</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="street" value="{{user.street}}" placeholder="Улица">
                            ...
                            <div class="col-md-2">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="build" value="{{user.build}}" placeholder="Дом">
                ...
                <div class="row profile-edit__wrap" data-child="false">
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="flat" placeholder="Кв./офис" value="{{user.flat}}">
                                    <div class="input__placeholder input__placeholder--dark">Кв./офис</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="intercom" placeholder="Домофон" value="{{user.intercom}}">
                                    <div class="input__placeholder input__placeholder--dark">Домофон</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="entrance" placeholder="Подъезд" value="{{user.entrance}}">
                                    <div class="input__placeholder input__placeholder--dark">Подъезд</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input input--grey">
                                    <input class="input__control" type="text" name="level" placeholder="Этаж" value="{{user.level}}">
