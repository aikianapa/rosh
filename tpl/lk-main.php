...
<div class="scroll-container" data-scroll-container>
    <main class="page" data-barba="container" data-barba-namespace="lk-admin-events-edit">
            ...
            <div class="container --flex --jcsb --aicn">
                <div class="header__admin --flex --aicn">
                    <span class="lower-deck">
                        ...
                        <a class="btn btn-link" href="/lk-admin-photos.html">Медиатека</a>
                    </span>
                    <a class="btn btn-link" href="/lk-admin-changes.html">Журнал изменений</a>
                </div>
                <div class="header__right --flex --aicn">
                    <button class="btn btn-link enter profile-menu">
                        ...
                        <div class="enter__panel">
                            <a class="enter__btn text-small" href="/lk-admin-edit.html">Редактировать</a>
        ...
        <div class="menu" id="mainmenu">
            <nav class="nav">
                <div class="nav__link">
                    <a href="all-services.html">Услуги</a>
                </div>
                <div class="nav__link">
                    <a href="all-problems.html">Проблемы</a>
                </div>
                <div class="nav__link">
                ...
                <div class="nav__link">
                    <a href="l-n-d.html">Libi & Daughters</a>
                </div>
                <div class="nav__link ddl">
                ...
                <div class="nav__group ddm">
                    ...
                    <div class="nav__link-inner">
                        <a href="experts.html">Специалисты</a>
                    </div>
                </div>
                <div class="nav__link">
            ...
            <div class="menu__contacts">
                <a class="text-small text-grey" href="contacts.html"> г. Москва, Ростовская набережная д. 5, пом. 9</a>
                <a class="text-small text-grey" href="mailto:info@medcenterrosh.ru">
                    info@medcenterrosh.ru</a>
            </div>
            <a class="en-version" href="en-version.html">
                    ...
                    <div class="account-scroll">
                        <div class="account__table">
                            ...
                            <div class="account__table-body">
                                    ...
                                    <div class="acount__table-main accardeon__main acount__table-auto">
                                        <div class="admin-events-item heap">
                                            ...
                                            <div class="flag-date">
                                                ...
                                                <span class="dt">
                                                    <strong class="title">Заявка: </strong>16.10.2021
                                                    <br>08:45</span>
                                            </div>
                                        </div>
                                        <div class="admin-events-item">
                                            <p>Приём</p>
                                            <span class="dt">17.10.2021
                                                <br>10:42</span>
                                        </div>
                                        <div class="admin-events-item">
                                            <p>ФИО</p>
                                            <a href="#">Цветкова Дарья Михайловна</a>
                                        </div>
                                        <div class="admin-events-item">
                                                                ...
                                                                <div class="select__list">
                                                                    ...
                                                                    <div class="select__item select__item--checkbox">
                                                                        <label class="checkbox checkbox--record">
                                                                            ...
                                                                            <span> </span>
                                                                            <div class="checbox__name --flex --aic --jcsb">
                                                                                <div class="select__name">Дерматологический пилинг Cosmedix Purity
                                                                                    ретиноевый
                                                                                </div>
                                                                                <div>7 000 ₽</div>
                                                                            </div>
                                                    ...
                                                    <div class="admin-editor__patient">
                                                        ...
                                                        <div class="search__drop-item">
                                                            <div class="search__drop-name">
                                                                ...
                                                                </div>Прием (осмотр, консультация врача-дерматовенеролога главного
                                                                врача первичный (включает составление плана лечения).
                                                            </div>
                                ...
                                <div class="acount__table-accardeon accardeon --red acount__table-accardeon--pmin">
                                    <div class="acount__table-main accardeon__main acount__table-auto">
                                        <div class="admin-events-item heap">
                                            <div class="accardeon__click"></div>
                                            <div class="flag-date">
                                ...
                                <div class="acount__table-accardeon accardeon --purple acount__table-accardeon--pmin">
                                    <div class="acount__table-main accardeon__main acount__table-auto">
                                        <div class="admin-events-item heap">
                                            <div class="accardeon__click"></div>
                                            <div class="flag-date">
                                    ...
                                    <div class="acount__table-main accardeon__main acount__table-auto">
                                        <div class="admin-events-item heap">
                                            ...
                                            <div class="flag-date">
                                                ...
                                                <span class="dt">
                                                    <strong class="title">Событие: </strong>16.10.2021
                                                    <br>08:45</span>
                                            </div>
                                        </div>
                                        <div class="admin-events-item">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="admin-editor__patient mb-40">
                                                        ...
                                                        <div class="row acount__photos-wrap">
                                                            <div class="col-md-2">
                                                                <a class="btn btn--white --openpopup" href="#" data-popup="--photo">Добавить фото</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button class="btn btn--white">Сохранить</button>
                ...
                <div class="container-fluid">
                    <div class="row footer__top">
                        ...
                        <div class="footer__item col-lg-3">
                            <a class="footer__contact text-small text-grey" href="mailto:info@medcenterrosh.ru">info@medcenterrosh.ru</a>
                        </div>
                        <div class="footer__item col-lg-7">
                            <a class="footer__contact text-small text-grey" href="contacts.html"> г. Москва, Ростовская набережная д. 5, пом. 9</a>
                        </div>
                    </div>
                    <div class="row footer__bottom">
                        <div class="footer__item col-lg-2">
                            <a class="text-small" href="index.html"> © ROSH, 2021</a>
                        </div>
                        <div class="footer__item col-lg-3">
                            <a class="text-small policy" href="policy.html"> Политика конфиденциальности</a>
                        </div>
                        <div class="footer__item col-lg-7 --flex --jcsb">
                            <a class="text-small map-site" href="site-map.html">Карта сайта</a>
                            <p class="text-small">Лицензия №ЛО-77-01-002172 от 12.01.2010</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <label class="checkbox mainfilter__checkbox">
                                            ...
                                            <span> </span>
                                            <div class="checbox__name">Консультация врача</div>
                                            <a class="checbox__link --openpopup" data-popup="--service" href="#">Подробнее </a>
                                        </label>
                        ...
                        <div class="mainfilter__tags">
                            <div class="mainfilter-tag">
                                <div class="mainfilter-tag__name">
                                    ...
                                    <a class="mainfilter-tag__link" href="/landing.html">Аллергия на коже</a>
                                </div>
                    ...
                    <div class="mainfilter__bottom">
                        <form class="mainfilter__form">
                            <div class="mainfilter__form-top">
                                ...
                                <div class="form__description">Нажимая на кнопку "Записаться", Вы даете согласие на обработку своих персональных данных
                                    на основании
                                    <a href="policy.html">Политики конфиденциальности</a>
                                </div>
                                <button class="form__submit btn btn--black">Записаться</button>
                            </div>
                            <div class="mainfilter__form-bottom">После отправки заявки для Вас будет создан Личный кабинет, в который можно попасть через кнопку
                                "Войти" в верхнем меню сайта</div>
                        </form>
...
<div class="popup --fast">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <div class="form-bottom">После отправки заявки для Вас будет создан Личный кабинет, в&nbsp;который можно попасть через кнопку &laquo;Войти&raquo;
...
<div class="popup --enter-number">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <a class="form__link --switchpopup" href="#" data-popup="--email-enter"> Войти по почте</a>
        </form>
...
<div class="popup --code">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <div class="form-title__description form-title__description--small">Мы отправили код подтверждения на номер
                <br>+7 939 319 33 38
                <a class="link" href="#"> Изменить</a>
            </div>
            <div class="code">
            ...
            <a class="form__link" href="#"> Отправить код повторно</a>
        </form>
    </div>
</div>
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <div class="text-right mb-10">
                <a class="form__link --switchpopup" data-popup="--email-recover">Забыли пароль?</a>
            </div>
            <div class="input input--grey">
                <input class="input__control" type="password" placeholder="Пароль">
                <div class="input__placeholder">Пароль</div>
            </div>
            <a class="form__link --switchpopup" type="button" data-popup="--enter-number"> Войти по номеру телефона</a>
...
<div class="popup --reg">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <div class="form__alert text-small">Адрес уже используется, хотите&nbsp;
                <a class="link link--medium" href="">восстановить пароль</a>?
...
<div class="popup --service">
    ...
    <div class="popup__panel">
        ...
        <div class="popup__img">
            <img src="/assets/img/popup/1.jpg" alt="">
        </div>
...
<div class="popup --problems">
    ...
    <div class="popup__panel">
        ...
        <div class="text">
            <p class="mb-10">Ответственны за этот процесс клетки иммунной системы – белки крови – иммуноглобулины Е. Они начинают вырабатываться
                при попадании в организм аллергена, который для каждого человека индивидуален. Аллергия проявляется в виде
                высыпаний, шелушения и покраснения кожных покровов, зуда, часто – затруднение дыхания, насморк, слезоточивость.жизни.
            </p>
        </div>
        <div class="popup__img">
            <img src="/assets/img/popup/1.jpg" alt="">
        ...
        <div class="text">
            <p class="mb-10">Диагноз «аллергия» ставится после проведения соответствующей диагностики: кожных проб и анализа крови, в некоторых
                случаях, при помощи лабораторных исследований можно выявить конкретный аллерген, но не всегда. В медицинском
                центре ROSH для диагностики и лечения аллергии мы также применяем биорезонансный аппарат BICOM.
            </p>
        </div>
        <div class="row mb-30">
            <div class="col-md-6">
...
<div class="popup --eq">
    ...
    <div class="popup__panel">
        ...
        <div class="text">
            <p class="mb-10">Медицинский центр "ROSH" представляет мультиплатформу Joule SCITON, которая на сегодня не знает аналогов во всем
                мире. Все Голливудские дивы уже по достоинству оценили и являются поклонниками данного аппарата.И есть от
                чего: единственная преследуемая цель процедуры - это удовлетворенность пациентов конечными результатами.
                Лазер SCITON поистине универсален, чтобы предложить эффективную и безопасную коррекцию большинства патологий
                кожи (дерматологических и эстетических) на всех типах кожи с минимальным восстановительным периодом и восхитительными
                результатами.</p>
        </div>
        <div class="gallery">
        ...
        <div class="text">
            ...
            <p>Кроме того, на данном аппарате проводится уникальная методика FOREVER YOUNG - мало того, что она устраняет абсолютно
                все недостатки, имеющиеся на лице и теле, это еще и омоложение на генном уровне!</p>
        </div>
    </div>
</div>
...
<div class="popup --record">
    ...
    <div class="popup__panel">
        ...
        <div class="input">
            ...
            <div class="search__drop">
                <label class="search__drop-item">
                    <div class="search__drop-name">Прием (осмотр, консультация врача-дерматовенеролога главного врача первичный (включает составление плана
                        лечения).</div>
        ...
        <div class="select-form" style="display: none;" data-show="service">
            ...
            <div class="popups__text-chexboxs">
                <label class="text-radio">
                    <input type="radio" name="status-service">
                    <span>В клинике</span>
                </label>
                <label class="text-radio switch-blocks">
                    <input type="radio" name="status-service">
        ...
        <div class="admin-editor__patient">
            ...
            <div class="search__drop-item">
                <div class="search__drop-name">
                    ...
                    <div class="search__drop-tags">
                        <div class="search__drop-tag --yellow">Л</div>
                    </div>Прием (осмотр, консультация врача-дерматовенеролога главного врача первичный (включает составление плана
                    лечения).
                </div>
                <label class="search__drop-right">
                    <div class="search__drop-summ">7 000 ₽</div>
            ...
            beforeRender: function(container, suggestions) {
                ...
                $(suggestions).each(function(index) {
                    ...
                    $(this.data.tags).each(function() {
                        TAGS.append(
                            $('<div></div>').addClass('search__drop-tag --' +
                                this.color).text(this.tag)
                        );
                    });
                    CNT.append(
                        $('<label></label>').addClass(
                            ...
                            $('<div></div>').addClass('search__drop-name').text(
                                this.value)
                        ).append(
...
<div class="popup --download">
    ...
    <div class="popup__panel">
        ...
        <a class="btn btn--black" href="#" download> Скачать</a>
    </div>
</div>
        ...
        <form class="popup__form">
            ...
            <label class="file-photo">
                ...
                <div class="file-photo__text text-grey">Для загрузки фото заполните все поля
                    <br>Фото не должно превышать 10 мб</div>
            </label>
            <button class="btn btn--white">Сохранить</button>
        </form>
    </div>
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            <div class="edit-photo">
                <div class="--flex --aicn">
                    <div class="edit-photo__pic">
                        <img src="/assets/img/popup/photo.png" alt="">
                    </div>
...
<div class="popup --create">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <div class="form-bottom">После отправки заявки для пациента будет создан Личный кабинет, в&nbsp;который можно попасть через кнопку &laquo;Войти&raquo;
                в&nbsp;верхнем меню сайта</div>
        </form>
    </div>
</div>
<div class="popup --create-recover">
    ...
    <div class="popup__panel">
        ...
        <form class="popup__form">
            ...
            <button class="btn btn--black form__submit --switchpopup" data-popup="--code">Создать</button>
            <div class="form-bottom">После отправки заявки для пациента создан Личный кабинет, в&nbsp;который можно попасть через кнопку &laquo;Войти&raquo;
                в&nbsp;верхнем меню сайта</div>
        </form>
    </div>
</div>
