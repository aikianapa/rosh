        ...
        <main class="page" data-barba="container" data-barba-namespace="lk-cabinet" wb-off>
            <div class="container">
                ...
                <div class="row --flex" style="">
                    <div class="col-md-6">Вы</div>
                    <div class="col-md-6">Специалист</div>
                </div>
                <div class="row --flex" style="">
                    <div class="col-md-6"><video id="localVideo" autoplay muted></video></div>
                    <div class="col-md-6"><video id="remoteVideo" autoplay></video></div>
                </div>
                <div class="row">
                    <div class="col-md-2">&nbsp;</div>
                    <div class="col-md-8 text-center"><p>Для окончания консультации закройте это окно</p></div>
                    <div class="col-md-2">&nbsp;</div>
                </div>
            </div>
        </main>
